class Strategy():
    ...
    def __init__(self):
        ...
        self.RSIN_long = 25
        self.multi = 0.1
        self.low_buy_point = 20
        self.high_sell_point = 80
    ...
    def trade(self, information):
        ...
        if (RSI6 < 30) and (RSI12 < 30) and (self.last_RSI12 > self.last_RSI6) and (RSI6 > RSI12) and (self.last_RSI6 < RSI6) and (self.last_RSI12 < RSI12):
        ...
        elif (RSI6 > 70) and (RSI12 > 70) and (self.last_RSI12 < self.last_RSI6) and (RSI6 < RSI12) and (self.last_RSI6 > RSI6) and (self.last_RSI12 > RSI12):
            self.first_exchange = 1
            return [
                {
                    'exchange': exchange,
